  ...
  return (
    <div className="flex flex-col min-h-screen bg-pink-50 relative">
      ...
      <div className="mt-12 border-t border-gray-200 pt-6 pb-8 text-center text-xs text-gray-400">
        ...
        <p>
          完整第三方许可证详见：
          <a href="https://github.com/yueyuezidaidaixue/ylypagehome/blob/main/THIRD-PARTY-NOTICES.md" className="underline hover:text-gray-600" target="_blank" rel="noopener noreferrer">THIRD-PARTY-NOTICES.md</a>
        </p>
        <p className="mt-2">
          本站源代码：
      ...
      <CreditsDrawer open={creditsOpen} onClose={() => setCreditsOpen(false)} />
    </div>
  )
}
